...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _create_new_tracker_create_new_tracker_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var _app_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./app.auth.guard */
    ...
    var routes = [{
      ...
      component: _create_new_tracker_create_new_tracker_component__WEBPACK_IMPORTED_MODULE_4__["CreateNewTrackerComponent"],
      canActivate: [_app_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]]
    }, {
      path: 'register',
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _app_auth_guard__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./app.auth.guard */
    "./src/app/app.auth.guard.ts");
  ...
  function srcAppAppServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var AppService = /*#__PURE__*/function () {
      ...
      _createClass(AppService, [{
        ...
        key: "setSessionId",
        value: function setSessionId(session_Id) {
        ...
        key: "setUserId",
        value: function setUserId(session_Id) {
  ...
  function srcAppCreateNewTrackerCreateNewTrackerComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function CreateNewTrackerComponent_div_1_div_5_div_1_Template(rf, ctx) {
      ...
      if (rf & 2) {
        var q_r16 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]().$implicit;
    ...
    function CreateNewTrackerComponent_div_1_div_5_div_2_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateNewTrackerComponent_div_1_div_5_div_2_div_1_Template_div_click_0_listener() {
          ...
          var oIndex_r24 = ctx.index;

          var qIndex_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).index;

          var ctx_r25 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r25.onClickRadioItem(oIndex_r24, qIndex_r17);
        });
    ...
    function CreateNewTrackerComponent_div_1_div_5_div_3_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function CreateNewTrackerComponent_div_1_div_5_div_3_div_1_Template_div_click_0_listener() {
          ...
          var oIndex_r31 = ctx.index;

          var qIndex_r17 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2).index;

          var ctx_r32 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](2);

          return ctx_r32.onClickCheckboxItem(oIndex_r31, qIndex_r17);
        });
    ...
    function CreateNewTrackerComponent_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function CreateNewTrackerComponent_div_1_Template_textarea_ngModelChange_9_listener($event) {
          ...
          return ctx_r36.additionalComments = $event;
        });
      ...
      _createClass(HomeComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this._appService.getUserInfo({}).subscribe(function (data) {
            ...
            _this4._appService.getUserHealthTracker({
              userId: _this4._appService.getUserId()
            }).subscribe(function (data) {
              if (data['code'] == 200) {
                _this4.hasActiveHT = true;
                _this4.healthTrackerData = data['data'];
                _this4.healthTrackerCount = 1;
                _this4.trackerId = _this4.healthTrackerData['tracker_id'];

                _this4.initializeTrackerDays();
              }
            });
          });
        }
      ...
      _createClass(LoginComponent, [{
        ...
        value: function onClickLoginBtn() {
          ...
          this._appService.login(payload).subscribe(function (data) {
            if (data['code'] == 200) {
              _this6._appService.setSessionId(data['session_id']);

              _this6._appService.setUserId(data['user_id']);

              _this6.onClickSignup();
            } else {
              alert(data['message']);
            }
          });
      ...
      template: function RegisterComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function RegisterComponent_Template_input_change_30_listener() {
            ...
            return ctx.onClickAgreementCheckbox(_r44.checked);
          });
